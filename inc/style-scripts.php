...
function themeFiles() {
    ...
    wp_register_script('gsap', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.0/gsap.min.js', array(), ASSETS_VERSION, true);
    wp_enqueue_script('gsap');

    wp_register_script('scrollTrigger', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.0/ScrollTrigger.min.js', array(), ASSETS_VERSION, true);
